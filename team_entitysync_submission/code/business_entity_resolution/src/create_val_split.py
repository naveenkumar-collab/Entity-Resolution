...
def create_val_split(
    s1_path: str = "D:/evalution/student_resource/dataset/train/train_source1.tsv",
    gt_path: str = "D:/evalution/student_resource/dataset/train/train_ground_truth.tsv",
    val_out_path: str = "D:/evalution/student_resource/val_ground_truth_30k.tsv",
    val_s1_out_path: str = "D:/evalution/student_resource/val_source1_30k.tsv",
    n_samples: int = 30000,
    random_state: int = 42
):
