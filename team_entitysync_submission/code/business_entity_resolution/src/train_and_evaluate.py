...
def build_training_pairs(
    ...
    val_s1_ids = set(pd.read_csv("D:/evalution/student_resource/val_source1_30k.tsv", sep="\t", usecols=["entity_id"])["entity_id"])
    
    # Load S1 train records excluding validation IDs
    train_s1_records = []
    with open("D:/evalution/student_resource/dataset/train/train_source1.tsv", "r", encoding="utf-8") as f:
    ...
    with open("D:/evalution/student_resource/dataset/train/train_ground_truth.tsv", "r", encoding="utf-8") as f:
        next(f)
        for line in f:
            parts = line.strip().split("\t")
...
def train_and_optimize():
    ...
    # Save model
    model_save_path = "D:/evalution/student_resource/model_lgb.joblib"
